...
def compile_ts(ctx,
  ...
  input_declarations = _get_transitive_ts_decls(ctx) + src_declarations
  ...
  # FIXME(alexeagle): where should the externs come from?
  ctx.file_action(output=ctx.outputs._js_typings,content="")
